function [nsp,species,X,R,lambda,dTe,B,Y]=rates_he3(Te,P,n,area_volume,Tg,only_e_balance,me,mg,e,S_abs,dt)
...
W(3)=-1/2*area_volume*n(3)*ub;
W(4)=0;
W(5)=-area_volume*0.25*n(5)*sqrt(8*1.6e-19*Tg/pi/mg/2);
W(6)=-1/2*area_volume*n(6)*ub/sqrt(2);
W(1)=W(3)+W(6); 
W(7)=0;
...
dTe=2/(3*e*n(1))*S_abs*dt...
    -2/3*(K(3)*24.59*n(7)+K(4)*4.7*n(2)+K(1)*19.82*n(7)+3*n(7)*me/mg*K(13)*Te)*dt...
