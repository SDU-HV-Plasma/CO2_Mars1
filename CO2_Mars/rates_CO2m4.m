function [nsp,species,X,R,lambda,dTe,B,Y,dS_ape,dS_el,dS_epro,dS_rea,dS_wall]=rates_CO2m4(Te,P,n,area_volume,Tg,only_e_balance,me,mg,e,S_abs,dt)
...
W(6)=0;
W(7)=0;
W(8)=-1/2*area_volume*n(8)*sqrt(1.6e-19*Te/mass(8));
W(1)=W(8);
% e: species 1
isp=1;
X(isp,1)=R(1);
...
dS_rea=-2/3*(13.7*K(1)*n(10))*dt;
dS_wall=-10/(3*n(1))*Te*(-W(1))*dt;
