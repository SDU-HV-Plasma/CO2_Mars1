function [nsp,species,X,R,lambda,dTe,B,Y]=rates_CO2m2(Te,P,n,area_volume,Tg,only_e_balance,me,mg,e,S_abs,dt)
...
dTe=2/(3*e*n(1))*S_abs*dt...
    -2*me/mg*K(18)*n(10)*(Te-Tg)*dt...
    -Te/n(1).*(sum(X(1,:)))*dt...
    -2/3*(13.7*K(1)*n(10))*dt...
    -10/(3*n(1))*Te*(-W(1))*dt;
