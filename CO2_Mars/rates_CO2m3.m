function [nsp,species,X,R,lambda,dTe,B,Y]=rates_CO2m3(Te,P,n,area_volume,Tg,only_e_balance,me,mg,e,S_abs,dt)
...
dTe=2/(3*e*n(1))*S_abs*dt...
    -2/3*n(10)*(K(1)*13.7+3*me/mg*K(18)*Te)*dt...
    -2/(3*n(1))*(-W(1))*(Te/2*log(mg/(2*pi*me))+5/2*Te)*dt...
    -(2e-16)*Te*n(1)*dt;
